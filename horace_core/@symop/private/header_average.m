...
% THIS SHOULD BE PUBLIC METHOD OF HEADERS CLASS
% used on headers after refactoring. Currently its the copy of the
% function, originally located in sqw/private
%
