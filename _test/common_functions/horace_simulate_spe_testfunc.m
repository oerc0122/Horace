function spe_file=horace_simulate_spe_testfunc (en, par_file, spe_file, sqwfunc, pars, scale, efix, emode, alatt, angdeg, u, v, psi, omega, dpsi, gl, gs)
% Simulate an spe file using an sqw model, with reproducible random looking noise
%
% >>spe_file=horace_simulate_spe_testfunc (en, par_file, spe_file, sqwfunc, pars, scale, efix, emode, alatt, angdeg, u, v, psi, omega, dpsi, gl, gs)
%
...
if isempty(seeds_store)
    seed_dir = fileparts(which('horace_simulate_spe_testfunc.m'));
